...
import { Lock, Handshake, Briefcase } from '@/components/ui/icons';
    ...
    <View className="flex-1 bg-[#F5F5F0] dark:bg-neutral-900">
      ...
      >
        ...
        <AnimatedCard delay={0} className="mb-6">
          <TouchableOpacity 
            className="w-full h-80 bg-[#F5E6E0] dark:bg-[#3D2C29] rounded-[32px] p-6 justify-between shadow-sm relative overflow-hidden"
            activeOpacity={0.9}
          >
             {/* 动态光晕装饰 */}
             <AnimatedGlow 
             ...
             <View>
                <View className="flex-row items-center space-x-2 mb-4 z-10">
                ...
                {/* Large CTA Text */}
                <Text className="text-4xl font-bold text-black dark:text-white leading-tight mb-2 z-10">
                   {translate('bonds.compatibility_score')}
                </Text>
                <Text className="text-sm text-neutral-600 dark:text-neutral-300 font-medium opacity-80 decoration-neutral-400 z-10">
                   {translate('bonds.compatibility_label')}
                </Text>
             </View>

             {/* Empty State Visual / Dashboard connector */}
             <View className="flex-row items-center justify-between mt-auto z-10">
        ...
        <View className="flex-row gap-3 w-full mb-3">
            ...
            <AnimatedCard delay={100} className="flex-1">
              <TouchableOpacity className="bg-[#E0EBE2] dark:bg-[#2A332C] rounded-[24px] p-4 min-h-[140px] justify-between shadow-sm relative overflow-hidden">
                  <AnimatedGlow 
                    color="wealth" 
                    size="small" 
                  ...
                  <View className="flex-row items-center space-x-1 mb-2 opacity-50 z-10">
                  ...
                  <Text className="text-sm font-medium text-green-900/70 dark:text-green-100/70 leading-tight z-10">
            ...
            <AnimatedCard delay={150} className="flex-1">
              <TouchableOpacity className="bg-[#4A2C38] dark:bg-[#583849] rounded-[24px] p-4 min-h-[140px] justify-between shadow-sm relative overflow-hidden">
                  {/* 动态光晕装饰 */}
                  <AnimatedGlow 
                    color="love" 
                    size="small" 
                  ...
                  <View className="z-10">
                    <Lock color="#fecdd3" width={24} height={24} />
                    <Text className="text-xs text-rose-100/60 leading-tight mt-1">
        ...
        <AnimatedCard delay={200} className="mb-3">
          <TouchableOpacity className="w-full bg-[#FFFBEB] dark:bg-[#423C26] rounded-[24px] p-5 shadow-sm relative overflow-hidden flex-row justify-between items-center">
              <AnimatedGlow 
                color="friend" 
                size="medium" 
              ...
              <View className="flex-[3] mr-4 z-10">
              ...
              <View className="flex-1 items-end z-10">
                <View className="w-10 h-10 rounded-full bg-yellow-900/10 dark:bg-white/10 flex items-center justify-center">
                    <Handshake color="#713f12" width={22} height={22} />
                </View>
              </View>
          </TouchableOpacity>
        </AnimatedCard>
        ...
        <View className="flex-row gap-3 w-full mb-8">
            ...
            <AnimatedCard delay={250} className="flex-1">
              <TouchableOpacity className="bg-[#FFF0F5] dark:bg-[#4A2633] rounded-[24px] p-4 min-h-[140px] justify-between shadow-sm relative overflow-hidden">
                  <AnimatedGlow 
                    color="love" 
                    size="small" 
                  ...
                  <Text className="text-sm font-medium text-pink-950/80 dark:text-pink-100/80 leading-tight z-10">
                    {translate('bonds.friend_bestie_desc')}
                  </Text>

                  <View className="flex-row justify-end mt-2 z-10">
            ...
            <AnimatedCard delay={300} className="flex-1">
              <TouchableOpacity className="bg-[#E6F0F5] dark:bg-[#1E293B] rounded-[24px] p-4 min-h-[140px] justify-between shadow-sm relative overflow-hidden">
                  <AnimatedGlow 
                    color="work" 
                    size="small" 
                  ...
                  <Text className="text-sm font-medium text-slate-800/80 dark:text-slate-200/80 leading-tight z-10">
                    {translate('bonds.friend_work_desc')}
                  </Text>

                  <View className="flex-row justify-end mt-2 z-10">
                      <View className="w-6 h-6 rounded-full bg-slate-300/30 flex items-center justify-center">
                        <Briefcase color="#334155" width={14} height={14} />
                      </View>
                  </View>
              </TouchableOpacity>
            </AnimatedCard>
